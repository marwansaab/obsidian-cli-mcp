...
- **SC-020**: The live-CLI characterisation pass (FR-025) documents observable behaviour for all 19 cases enumerated (including the Setext-underline-as-content case added by the 2026-05-09 clarifications session), persisted in the feature's research artefact and surfaceable from the published documentation.
