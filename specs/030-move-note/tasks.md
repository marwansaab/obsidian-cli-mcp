...
- **Test count**: ~57 cases total (~24 schema in T004, ~28 handler split across T010 (5) + T011 (6) + T012 (2) + T013 (2) + T014 (2) + T015 (5) + T022 (1), ~5 registration in T019). Matches the FR-016 inventory locked in data-model.md.
