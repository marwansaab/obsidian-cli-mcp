...
| Promoting the contract to a project-level location (`specs/contracts/errors.md`) | Deferred (Q5). Right *eventual* answer once the contract grows beyond ~10 codes; over-engineering at the v0.1.1 stage. |
