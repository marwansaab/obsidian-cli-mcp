...
- **FR-007**: The cohort of tools carrying the "silently honoured-as-noop `vault=` parameter" claim MUST be enumerated in writing as part of this feature's research artefacts, comprising the established cohort plus the four tools added by audit finding F1.
