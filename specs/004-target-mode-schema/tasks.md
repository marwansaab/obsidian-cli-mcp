...
- [ ] T021 [US4] Add Story 4 `expectTypeOf` assertions to [src/target-mode/target-mode.test.ts](../../src/target-mode/target-mode.test.ts) for AC #1 + AC #2 (two test bodies). Use vitest's built-in `expectTypeOf` (imported in T002):
