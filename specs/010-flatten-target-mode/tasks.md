...
- [ ] T001 Atomic flatten of `target-mode.ts` (rewrite + handler tweak + 8 test edits in one commit). Per [contracts/flat-target-mode.contract.md](contracts/flat-target-mode.contract.md) and [data-model.md](data-model.md) §2. FR-001 / FR-002 / FR-003 / FR-004 / FR-017.
