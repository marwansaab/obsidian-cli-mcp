...
test("createServer registers exactly THIRTY-THREE tools (FR-001 + FR-007 + P8 aggregator + BI-003 + BI-011 + BI-012 + BI-013 + BI-014 + BI-015 + BI-018 + BI-019 + BI-021 + BI-022 + BI-023 + BI-024 + BI-025 + BI-026 + BI-027 + BI-028 + BI-029 + BI-030 + BI-033 + BI-035 + BI-036 + BI-037 + BI-038 + BI-039 + BI-040 + BI-043 + BI-044 + BI-045 + BI-049 + BI-057 + BI-082 + BI-083)", async () => {
  const { ctx } = makeContext();
  const { server } = createServer(ctx);
  ...
  expect(names).toEqual(["append_note", "backlinks", "bases", "context_search", "create_base", "delete", "files", "find_and_replace", "find_by_property", "help", "links", "move", "obsidian_exec", "open_file", "outline", "patch_block", "patch_heading", "paths", "pattern_search", "prepend", "properties", "query_base", "read", "read_heading", "read_property", "rename", "search", "set_property", "smart_connections_query", "smart_connections_similar", "tag", "views_base", "write_note"]);
});
