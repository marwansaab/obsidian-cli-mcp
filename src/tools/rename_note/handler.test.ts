// Original — no upstream. Tests for the rename_note handler — argv assembly per /speckit-clarify Q1 (appendMdIfMissing), parseRenameResponse against T0-locked F2/F12 pattern, single-spawn invariant (R9), UpstreamError propagation across the four cli-adapter codes + ERR_NO_ACTIVE_FILE, same-name audit invariant (Story 9).
