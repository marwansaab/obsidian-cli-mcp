// Original — no upstream. rename_note handler: thin transformer routing parsed input through invokeCli — appendMdIfMissing helper per /speckit-clarify Q1, parseRenameResponse regex locked against T0 capture.
