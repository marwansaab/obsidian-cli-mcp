// Original — no upstream. Tests for the delete_note handler — argv assembly (no rename), response parsing, structural toTrash, audit invariant, UpstreamError propagation.
