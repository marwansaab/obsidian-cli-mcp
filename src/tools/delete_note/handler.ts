// Original — no upstream. delete_note handler: thin transformer routing parsed input through invokeCli — argv assembly (NO file→name rename per R3), flag-form permanent per R2, structural toTrash derivation per R4 (toTrash = !parsed.permanent), response parsing locked against T0-captured wording.
