// Original — no upstream. list_files tool registration via registerTool — folder-scoped typed enumeration; responseFormat: "json" (default) wraps the { count, paths } envelope for the MCP wire.
