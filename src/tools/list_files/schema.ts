// Original — no upstream. list_files input/output schemas — folder-scoped target-mode refinement (forbids file AND path in BOTH modes); optional folder/ext/total fields with R15 empty-string rejection; strict output { count, paths }.
import { z } from "zod";
